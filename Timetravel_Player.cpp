...
bool init()
{
	...
	else
	{
		...
		//Create window
		gWindow = SDL_CreateWindow( "Player Mover", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN );
		if( gWindow == NULL )
		{
...
bool loadMedia()
{
	...
	//Load dot texture
	if( !gDotTexture.loadFromFile( "C:/Users/Travis/Documents/NetBeansProjects/Timetravel_Player/dot.gif" ) )
	{
